...
case 'init'
    ...
    for f = 1:5
        ...
        btnY = 2*floor((9-f)/3)*btnSize+baseY+5;
    ...
    fireBtnA = text('Parent',axeCars, ...
                    'Position',[carAaxes+carInternalViewWidth/2-8 30], ...
                    'String','FIRE', ...
    ...
    fireBtnB = text('Parent',axeCars, ...
                    'Position',[carBaxes+carInternalViewWidth/2-8 30], ...
                    'String','FIRE', ...
                    'BackgroundColor',inactiveFireColor, ...
                    'Color','w', ...
                    'FontSize',7, ...
